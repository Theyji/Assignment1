...
builder.Services.AddDbContext<assignment1Context>(options =>
    options.UseSqlite(builder.Configuration.GetConnectionString("assignment1ContextLite") ?? throw new InvalidOperationException("Connection string 'assignment1ContextLite' not found.")));
